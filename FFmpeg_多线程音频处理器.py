...
# -*- coding: utf-8 -*-
"""
FFmpeg 多线程音频白噪音混合处理器
使用多线程并行处理音频文件，添加白噪音和环境音
"""
...
class FFmpegMultiThreadProcessor:
    def __init__(self):
        ...
        print("   ✅ 规则7: 多线程并行处理")
        print(f"   ✅ 规则8: 白噪音文件: {self.white_noise_file}")
        print("=" * 60)
    ...
    def print_progress(self):
        ...
        print("🎵 FFmpeg 多线程音频白噪音混合处理器 - 实时处理看板")
        print("=" * 80)
    ...
    def get_optimal_thread_count(self):
        ...
        # 考虑I/O密集型任务，使用CPU核心数的2-4倍
        # 但不超过32个线程，避免系统负载过高
        optimal_threads = min(cpu_count * 3, 32)
        
        print(f"💻 检测到 {cpu_count} 个CPU核心")
        print(f"🎯 推荐使用 {optimal_threads} 个线程")
    ...
    def process_all_audio_files(self, max_workers=None):
        ...
        print(f"🚀 启动 {max_workers} 个并行处理线程 (最大性能模式)")
...
def main():
    """主函数"""
    processor = FFmpegMultiThreadProcessor()
    ...
    # 开始多线程处理
    print("\n🚀 开始多线程处理...")
    success = processor.process_all_audio_files(max_workers=8)
